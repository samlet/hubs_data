...
part 'src/schema/work_effort_type_collection.dart';
...
part 'src/schema/fixed_asset_type_collection.dart';
...
part 'src/schema/work_effort_skill_standard_collection.dart';
part 'src/schema/product_price_collection.dart';
part 'src/schema/shopping_list_type_collection.dart';
part 'src/schema/invoice.dart';
part 'src/schema/product_category_type.dart';
...
part 'src/schema/work_effort_fixed_asset_assign_collection.dart';
part 'src/schema/temporal_expression_assoc.dart';
...
part 'src/schema/temporal_expression_assoc_collection.dart';
...
part 'src/schema/party_type_collection.dart';
...
part 'src/schema/temporal_expression_collection.dart';
...
part 'src/schema/shopping_list_type.dart';
part 'src/schema/fact_proto.dart';
part 'src/schema/typed_value.dart';
part 'src/schema/work_effort_skill_standard.dart';
...
part 'src/schema/order_type_collection.dart';
...
part 'src/schema/product_store_group_type.dart';
...
part 'src/schema/data_resource_type.dart';
...
part 'src/schema/example_type_collection.dart';
...
part 'src/schema/facility_type_collection.dart';
...
part 'src/schema/mirror_proto_value.dart';
...
part 'src/schema/raw_result_set_value.dart';
part 'src/schema/agreement_item.dart';
part 'src/schema/shipment_route_segment_collection.dart';
part 'src/schema/image_data_resource_collection.dart';
...
part 'src/schema/fact_proto_type_collection.dart';
...
part 'src/schema/electronic_text_collection.dart';
...
part 'src/schema/work_effort_fixed_asset_assign.dart';
part 'src/schema/types_entity_type.dart';
...
part 'src/schema/party_group_collection.dart';
...
part 'src/schema/product_type_collection.dart';
part 'src/schema/party_type.dart';
part 'src/schema/blacklist_type.dart';
...
part 'src/schema/payment_gateway_response_collection.dart';
...
part 'src/schema/contact_mech_type_collection.dart';
...
part 'src/schema/facility_type.dart';
...
part 'src/schema/data_resource_type_collection.dart';
part 'src/schema/inventory_item_type_collection.dart';
part 'src/schema/party_contact_mech_collection.dart';
part 'src/schema/types_entity_type_collection.dart';
part 'src/schema/work_effort_status.dart';
...
part 'src/schema/example_type.dart';
...
part 'src/schema/product_feature_type.dart';
...
part 'src/schema/user_login_session_collection.dart';
...
part 'src/schema/person_collection.dart';
...
part 'src/schema/invoice_type_collection.dart';
...
part 'src/schema/video_data_resource_collection.dart';
...
part 'src/schema/temporal_blueprint.dart';
...
part 'src/schema/order_fact_type_collection.dart';
part 'src/schema/order_payment_preference_collection.dart';
part 'src/schema/contact_mech_type.dart';
...
part 'src/schema/payment_gateway_response.dart';
...
part 'src/schema/payment_type.dart';
...
part 'src/schema/product_feature_type_collection.dart';
part 'src/schema/postal_address_collection.dart';
...
part 'src/schema/inventory_item_type.dart';
...
part 'src/schema/work_effort_status_collection.dart';
part 'src/schema/shipment_blueprint.dart';
part 'src/schema/work_effort_type.dart';
...
part 'src/schema/telecom_number_collection.dart';
part 'src/schema/fixed_asset_type.dart';
part 'src/schema/order_contact_mech_collection.dart';
part 'src/schema/postal_address.dart';
part 'src/schema/shopping_list.dart';
part 'src/schema/user_login_session.dart';
...
part 'src/schema/invoice_type.dart';
part 'src/schema/requirement_type.dart';
part 'src/schema/blacklist_type_collection.dart';
part 'src/schema/party_blueprint.dart';
part 'src/schema/agreement_role.dart';
part 'src/schema/product_category_type_collection.dart';
part 'src/schema/vendor_product.dart';
part 'src/schema/types_entity_status_collection.dart';
part 'src/schema/temporal_expression.dart';
...
part 'src/schema/audio_data_resource_collection.dart';
part 'src/schema/fixed_asset_maint_collection.dart';
part 'src/schema/order_type.dart';
part 'src/schema/work_effort_blueprint.dart';
part 'src/schema/product_store_facility.dart';
part 'src/schema/product_store_group_type_collection.dart';
...
part 'src/schema/order_fact_type.dart';
part 'src/schema/payment_type_collection.dart';
